...
\hypersetup{
  ...
  pdfauthor={Replace with Your Name},
  hidelinks,
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{uppercase\_matrix }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(LETTERS, }\AttributeTok{nrow =} \DecValTok{2}\NormalTok{, }\AttributeTok{ncol =} \DecValTok{13}\NormalTok{, }\AttributeTok{byrow =} \ConstantTok{TRUE}\NormalTok{)}
